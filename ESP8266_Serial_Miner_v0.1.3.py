##########################################
# XeRi-Coin Python ESP Miner (v0.1.3)
...
with open('ESP8266_Serial_Miner_0.1.3_resources/ESPConfigure.ini', 'w') as configfile:
    config.write(configfile)
    
config = configparser.ConfigParser()
config.read('ESP8266_Serial_Miner_0.1.3_resources/ESPConfigure.ini')
...
print(colored(Style.BRIGHT + '# XeRi-Coin Python ESP Miner (v0.1.3)      #' , 'white' , 'on_cyan'));
